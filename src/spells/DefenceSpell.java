 ...
 * @author Ivan Stuart
 * 
 *         Rules for defence effect on attack spells. 1 absorb 1 2 absorb 1
 *         reflect 1 3 absorb 2 reflect 1 4 absorb 2 reflect 2 5 absorb 3
 *         reflect 2
 * 
...
public class DefenceSpell extends Sprite implements SpellInterface {
	...
	public DefenceSpell(Sprite wizard, int direction, int pwr) {
		...
		level = pwr / 80;
		String spellString = String.valueOf(level) + "d";
		...
		this.y = myWizard.getY() + 90 - (this.height / 2);
