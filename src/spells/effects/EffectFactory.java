...
public class EffectFactory {
	...
	private static Map<String, SpellEffect> effectMap = new HashMap<String, SpellEffect>();
	...
	private void init() {
		...
		effectMap.put("1o", new CurePosion(0));
		effectMap.put("2o", new Posion(500));
		effectMap.put("3o", new Posion(300));
