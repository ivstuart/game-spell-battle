...
public class JWizardDesigner extends JPanel {
	...
	class WizardSpinnerModel extends SpinnerNumberModel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -7609245483537650540L;
		...
		public void setValue(Object value) {
			...
			int newTotal = getPool() + ((Integer) super.getValue()).intValue()
					- number;
	...
	// private void setPointPoints(String value) {
	// poolLabel.setText(value);
	// }
